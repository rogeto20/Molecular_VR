...
public class SteamVR_Controller {
	...
	public class Device {
		...
		public Vector3 velocity {
			get {
				Update ( );
				return new Vector3 ( pose.vVelocity.v0,
				                     pose.vVelocity.v1,
				                     -pose.vVelocity.v2 );
			}
		}
		...
		public Vector3 angularVelocity {
			get {
				Update ( );
				return new Vector3 ( -pose.vAngularVelocity.v0,
		...
		public void Update ( ) {
			if ( Time.frameCount != prevFrameCount ) {
				...
				if ( system != null ) {
					valid = system.GetControllerStateWithPose ( SteamVR_Render.instance.trackingSpace,
					                                            index,
					                                            ref state,
